            ...
            else //escolha de ano
            {
                ...
                switch (ano)
                {
                    case "2004":
                        ...
                        listBox1.Items.Clear();
                        listBox1.Items.Add("Greg Yaitanes");
                        listBox1.Items.Add("Deran Sarafian");
                        listBox1.Items.Add("Daniel 'Dan' Attias");
                        listBox1.Items.Add("Daniel Sackheim ");
                        listBox1.Items.Add("Miguel Sapochnik");
                        listBox1.Items.Add("David Platt");
                        listBox1.Items.Add("Matt Shakman");

                        listBox2.Items.Add("David Shore");
                        listBox2.Items.Add("David Hoselton");
                        listBox2.Items.Add("Sara Hess ");
            ...
            if (radioButton1.Checked == true) //episodios
            {
                ...
                switch (eps)
                {
                    ...
                    case "Ep 15 - Vidas Particulares":
                        ...
                        richTextBox2.Text = "Frankie foi o blogueiro admitido em Princeton Plainsboro no episódio Vidas Particulares. Ela foi interpretada pela atriz Laura Prepon. Frankie é vegetariana há vários meses, embora continue a comer peixe. Frankie chegou ao pronto-socorro do Hospital Universitário de Princeton-Plainsboro depois de apresentar vários hematomas no rosto e sangramento pela boca. Ela foi internada para observação depois que os médicos determinaram que ela tinha algum tipo de colaguopatia. ";
